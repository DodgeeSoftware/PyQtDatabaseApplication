...
# Find Customer Window Class
class FindCustomerWindow(QMainWindow):
	...
	def __init__(self):
		...
		# Customer Window
		self.__customerWindow = CustomerWindow()
	...
	def okButtonPushed(self):
		...
		if databaseWrapper.isCustomer(customerID) == True:
			customer = databaseWrapper.getCustomer(customerID)
			self.__customerWindow.setCustomer(customer)
			self.__customerWindow.show();
